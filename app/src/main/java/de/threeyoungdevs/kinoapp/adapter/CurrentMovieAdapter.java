...
public class CurrentMovieAdapter extends RecyclerView.Adapter<CurrentMovieAdapter.MyViewHolder> {
    ...
    public CurrentMovieAdapter(String[] myDataset, Context context) {
        mDataset = myDataset;
        mContext = context;
    }
    ...
    @Override
    public CurrentMovieAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                               int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.movie_name.setText("Test");
